...
/* Methods for dealing with transfer functions (= perturbation vectors) */
...
struct perturb_data {
    ...
    double *redshift;
    /* Vector of growth factors (tau_size) */
    double *D_growth;
...
int readPerturbParams(struct units *us, struct perturb_params *ptpars,
                      char *fname);
