...
static inline void accelCIC_4th(const GridFloatType *box, const double x[3],
                                double a[3], const int N, const int X0,
                                const int buffer_width, const int Nz,
...
/* Note: code generated with mesh_grav_generate.py. Do not change by hand */
static inline void accelCIC_2nd(const GridFloatType *box, const double x[3],
                                double a[3], const int N, const int X0,
                                const int buffer_width, const int Nz,
                                const double cell_fac) {
...
/* Note: code generated with mesh_grav_generate.py. Do not change by hand */
static inline void accelCIC_1st(const GridFloatType *box, const double x[3],
                                double a[3], const int N, const int X0,
                                const int buffer_width, const int Nz,
                                const double cell_fac) {
